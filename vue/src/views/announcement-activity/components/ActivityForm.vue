...
import type { ActivityRequest } from '@/stores/activity/interface/activity.interface';
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12">
                                <v-text-field label="Date" type="date" v-model="req.date" required></v-text-field>
                            </v-col>
                            <v-col cols="12">
                                <v-textarea label="Label" v-model="req.description" required></v-textarea>
                            </v-col>
